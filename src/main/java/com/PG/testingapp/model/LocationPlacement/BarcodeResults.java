...
public class BarcodeResults {
    ...
    public BarcodeResults(String PP_Number, String PP_Date, String FK_CS_Pellet_Location_No, String FK_CS_Pellet_Location_Visible_No, String PP_Total_No_of_Cartons, String status) {
